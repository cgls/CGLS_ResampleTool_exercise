...
if(Sys.info()[4] == "D01RI1700371"){
  ...
  path2data <- "/Users/xavi_rp/Documents/D6_LPD/lai_data"
  path2save <- "/Users/xavi_rp/Documents/D6_LPD/lai_resample/LAI_resample_amazonia"
}else{
...
lai_1km_orig <- paste0(path2data, "/lai_v1_1km/lai_v1_1km_c_gls_LAI_201905030000_GLOBE_PROBAV_V1.5.1.nc")
