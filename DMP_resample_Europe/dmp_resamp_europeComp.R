...
if(date == "may19"){
  nc_file300m <- paste0(path2data, "/dmp300_v1_333m/dmp300_v1_333m_c_gls_DMP300-RT5_201905100000_GLOBE_PROBAV_V1.0.1.nc")
  dmp_1km_orig <- paste0(path2data, "/dmp_v2_1km/dmp_v2_1km_c_gls_DMP-RT6_201905100000_GLOBE_PROBAV_V2.0.1.nc")
